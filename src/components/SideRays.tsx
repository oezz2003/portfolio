...
void main() {
  ...
  vec2 rayRefDir1 = normalize(vec2(cos(2.356194 + halfSpread), sin(2.356194 + halfSpread)));
  vec2 rayRefDir2 = normalize(vec2(cos(2.356194 - halfSpread), sin(2.356194 - halfSpread)));
